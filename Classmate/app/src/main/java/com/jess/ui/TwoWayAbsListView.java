...
/**
 * Base class_stu that can be used to implement virtualized lists of items. A list does
 * not have a spatial definition here. For instance, subclases of this class_stu can
...
//	//}
	...
	/**
	 * A base class_stu for Runnables that will check that their view is still attached to
