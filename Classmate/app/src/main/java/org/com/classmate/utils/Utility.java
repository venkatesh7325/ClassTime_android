...
public class Utility {
    ...
    public static void saveInstitutionID(Context context, String id) {
        appContext = context;
        SharedPreferences sharedPreferences = appContext.getSharedPreferences(Constants.CLASSTIME_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("inst_id", id);
        editor.apply();
    }

    public static String getInstitutionId(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.CLASSTIME_PREF, Context.MODE_PRIVATE);
        return sharedPreferences.getString("inst_id", "");
    }
    ...
    public static void doCall(Context context, String phoneNumber) {
        Intent intent = new Intent(android.content.Intent.ACTION_CALL, Uri.parse("tel: 7829648388"));
    ...
    public static void senSms(Context context, String phoneNumber) {
